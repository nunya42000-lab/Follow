...
// --- MERGED DOM OBJECT & ASSIGNMENT (FROM DOM.JS) ---
export let DOM = {}; 
...
// --- MERGED UTILS FUNCTIONS (FROM UTILS.JS) ---
let toastTimer = null;
...
export function showToast(message, duration = 2000) {
    ...
    // DOM object is now guaranteed to be populated before this is called by the app logic
...
(function() {
    ...
    async function initApp() {
        ...
        // --- 2. STANDARD LOAD ---
        loadState(); 
        assignDomElements(); // GUARANTEED to run before any DOM access via listeners
