...
export const MAPPING_PRESETS = {
    '9key_taps': {
        name: "Taps Standard",
        map: {
            'k9_1':{g:'tap'}, 'k9_2':{g:'double_tap'}, 'k9_3':{g:'long_tap'},
            'k9_4':{g:'tap_2f'}, 'k9_5':{g:'double_tap_2f'}, 'k9_6':{g:'long_tap_2f'},
            'k9_7':{g:'tap_3f'}, 'k9_8':{g:'double_tap_3f'}, 'k9_9':{g:'long_tap_3f'}
        }
    },
    '9key_swipes': {
        name: "Swipes Directional",
        map: {
            'k9_1':{g:'swipe_nw'}, 'k9_2':{g:'swipe_up'}, 'k9_3':{g:'swipe_ne'},
            'k9_4':{g:'swipe_left'}, 'k9_5':{g:'tap'}, 'k9_6':{g:'swipe_right'},
            'k9_7':{g:'swipe_sw'}, 'k9_8':{g:'swipe_down'}, 'k9_9':{g:'swipe_se'}
        }
    },
    '12key_taps': {
        name: "Taps Extended",
        map: {
            'k12_1':{g:'tap'}, 'k12_2':{g:'double_tap'}, 'k12_3':{g:'triple_tap'}, 'k12_4':{g:'long_tap'},
            'k12_5':{g:'tap_2f'}, 'k12_6':{g:'double_tap_2f'}, 'k12_7':{g:'triple_tap_2f'}, 'k12_8':{g:'long_tap_2f'},
            'k12_9':{g:'tap_3f'}, 'k12_10':{g:'double_tap_3f'}, 'k12_11':{g:'triple_tap_3f'}, 'k12_12':{g:'long_tap_3f'}
        }
    },
    '12key_swipes': {
        name: "Swipes Multi-Finger",
        map: {
            'k12_1':{g:'swipe_left'}, 'k12_2':{g:'swipe_up'}, 'k12_3':{g:'swipe_down'}, 'k12_4':{g:'swipe_right'},
            'k12_5':{g:'swipe_left_2f'}, 'k12_6':{g:'swipe_up_2f'}, 'k12_7':{g:'swipe_down_2f'}, 'k12_8':{g:'swipe_right_2f'},
            'k12_9':{g:'swipe_left_3f'}, 'k12_10':{g:'swipe_up_3f'}, 'k12_11':{g:'swipe_down_3f'}, 'k12_12':{g:'swipe_right_3f'}
        }
    },
    'piano_swipes': {
        name: "Piano Swipes",
        map: {
            'piano_1':{g:'swipe_left_2f'}, 'piano_2':{g:'swipe_nw_2f'}, 'piano_3':{g:'swipe_up_2f'}, 'piano_4':{g:'swipe_ne_2f'}, 'piano_5':{g:'swipe_right_2f'},
            'piano_C':{g:'swipe_nw'}, 'piano_D':{g:'swipe_left'}, 'piano_E':{g:'swipe_sw'}, 'piano_F':{g:'swipe_down'},
            'piano_G':{g:'swipe_se'}, 'piano_A':{g:'swipe_right'}, 'piano_B':{g:'swipe_ne'}
        }
    }
};

const SYSTEM_ACTIONS = [
    { id: 'toggle_blackout', label: 'Toggle Blackout' },
    { id: 'toggle_input_gestures', label: 'Toggle Input Gestures' },
    { id: 'reset_game', label: 'Reset Game' },
    { id: 'backspace', label: 'Backspace' },
    { id: 'play_demo', label: 'Play/Stop Demo' },
    { id: 'toggle_hud', label: 'Toggle HUD' },
    { id: 'timer_toggle', label: 'Timer Start/Stop' },
    { id: 'timer_reset', label: 'Timer Reset' },
    { id: 'counter_inc', label: 'Counter +1' },
    { id: 'counter_reset', label: 'Counter Reset' }
];
...
export class SettingsManager {
    ...
    cacheDOM() {
        return {
            ...
            hapticPause: document.getElementById('haptic-pause-select'),
