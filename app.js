...
(function() {
    ...
    const DEFAULT_PROFILE_SETTINGS = {
        ...
        flashSensitivity: 50, // Maps to THRESHOLD in the engine
    ...
    // --- CAMERA ENGINE STATE (From Skill Vision 2.1) ---
    let cameraStream = null;
    let isDetecting = false;
    let detectionLoopId = null;
    let baselineData = new Array(12).fill(0); // Supports up to 12 keys
    let lastHitTime = 0; // Global debounce timer
