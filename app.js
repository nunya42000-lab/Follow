...
function assignDomElements() {
    els = {
        ...
        // FIX: Select by CLASS
        camBtns: document.querySelectorAll('.camera-control-btn'),
        micBtns: document.querySelectorAll('.mic-control-btn'),
        // Sliders
...
function updateAllChrome() {
    const settings = getSettings();
    // Safe checks using optional chaining (?.) to prevent crashes if elements are missing
...
function initListeners() {
    document.addEventListener('click', (e) => {
        ...
        // FIXED: Using data-action for sensors
