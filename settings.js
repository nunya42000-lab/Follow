...
(function(){
    ...
    function initStealthTab() {
        ...
        if(bg) bg.onchange = function(){ if(window.appSettings) window.appSettings.isBlackoutGesturesEnabled = bg.checked; if(window.settingsManager && settingsManager.callbacks && settingsManager.callbacks.onSave) settingsManager.callbacks.onSave(); };
    }
