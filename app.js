...
(function() {
    ...
    var openCommentModalBtn = null; // NEW
...
Let's start with Round 1.`;
    ...
    function assignDomElements() {
        ...
        openCommentModalBtn = document.getElementById('open-comment-modal'); // NEW
    ...
    function initializeListeners() {
        ...
        document.addEventListener('click', (event) => {
            ...
            if (action === 'open-comments') { closeSettingsModal(); openCommentModal(); return; } // NEW
            if (action === 'copy-link') {
