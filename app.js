...
(function() {
    ...
    async function initApp() {
        ...
        // CRITICAL FIX: Robust check for DOM availability
        ...
        if (appSettings.showWelcomeScreen) {
            // Small delay ensures CSS transitions work
    ...
    // Ensure DOM is fully ready before running init
    ...
    function initializeListeners() {
        // Master Switch Listeners - CRITICAL FIX: Use attribute selector for duplicates
        document.body.addEventListener('click', (e) => {
            if (e.target.closest('[id="camera-master-btn"]')) {
            ...
            if (e.target.closest('[id="mic-master-btn"]')) {
