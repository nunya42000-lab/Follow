// app.js - Fixed Null Reference Crash
...
// --- CONSTANTS ---
const SETTINGS_KEY = 'followMeAppSettings_v12'; // Bumped version to force clean state
...
function switchToCustomProfile() {
    ...
    // Force value update on dropdowns
