...
export function assignDomElements() {
    ...
    // CRITICAL FIX: Use attribute selector [id="..."] to capture ALL duplicates
    DOM.allCameraMasterBtns = document.querySelectorAll('[id="camera-master-btn"]'); 
    DOM.allMicMasterBtns = document.querySelectorAll('[id="mic-master-btn"]');       
}
