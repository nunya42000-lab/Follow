...
export function applyDeveloperVisibility() {
    ...
    if (voiceSection) {
        appSettings.devHideVoiceSettings ? voiceSection.classList.add('hidden') : voiceSection.classList.remove('hidden');
    }
    if (hapticSection) {
        appSettings.devHideHapticSettings ? hapticSection.classList.add('hidden') : hapticSection.classList.remove('hidden');
    }
