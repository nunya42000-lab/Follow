...
if (this.dom.gestureSwipeSlider) {
    ...
    updateHeaderVisibility() {
        ...
        const handBtn = document.getElementById('header-hand-btn'); // <--- ADDED THIS
        ...
        const showHand = !!this.appSettings.isHandGesturesEnabled; // <--- ADDED THIS
        ...
        if(handBtn) handBtn.classList.toggle('hidden', !showHand); // <--- ADDED THIS

        // Check if header should be hidden entirely
        // ADDED !showHand to the check below
