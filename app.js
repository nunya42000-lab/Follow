...
(function() {
    ...
    async function initApp() {
        ...
        if (!DOM.sequenceContainer) {
            console.warn("DOM elements not found. Retrying init...");
        ...
        // Removed auto-speak on load to prevent browser block errors
    ...
    function initializeListeners() {
        ...
        // We handle this FIRST so the global blocker doesn't stop it
        document.body.addEventListener('click', (e) => {
            // Check for class name instead of ID
        ...
        document.addEventListener('click', (event) => {
            ...
            // Ignore Master Buttons here (handled above) to avoid logic conflict
            ...
            // Logic to prevent clicking buttons on hidden keypads
    ...
    function openHelpModal() {
        const profileSettings = getCurrentProfileSettings();
        const mode = profileSettings.currentMode;
        // Generate prompts logic moved inline here or externalized if huge
        // For now, simple visibility toggles are enough for the help modal structure
