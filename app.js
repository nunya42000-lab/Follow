...
(function() {
    ...
    const ENGINE_THRESHOLD = 40;   // Sensitivity threshold (0-255)
    const ADAPTIVE_FACTOR = 0.2;   // Baseline adaptation speed (0.2 = 20% new, 80% history)
    const FLASH_DEBOUNCE_MS = 300; // Minimum time between hits
    ...
    const DEFAULT_PROFILE_SETTINGS = {
        ...
        flashSensitivity: 50, // Kept for UI compatibility
...
// =================================================================
// === SKILL VISION ENGINE 2.1 (CENTER POINT + ADAPTIVE) ===
// =================================================================
...
function startDetection() {
    ...
    // Reset baseline to zeroes to allow fast adaptation on first frame
    baselineData.fill(0); 
    lastHitTime = 0;
...
function runDetectionLoop() {
    ...
    for (let i = 0; i < numBoxes; i++) {
        ...
        // === KEY: Sample ONLY the center pixel ===
        ...
        // Update Adaptive Baseline (Fast Drift)
