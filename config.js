...
export const DEFAULT_PROFILE_SETTINGS = {
    ...
    machineCount: 1,
    // shortcuts: [], // Removed to force explicit creation
    shakeSensitivity: 10,
...
// Fix: Explicitly create new arrays for shortcuts to avoid shared memory
export const PREMADE_PROFILES = {
    'profile_1': { name: "Follow Me", settings: { ...DEFAULT_PROFILE_SETTINGS, shortcuts: [] } },
    'profile_2': { name: "2 Machines", settings: { ...DEFAULT_PROFILE_SETTINGS, machineCount: 2, simonChunkSize: 4, simonInterSequenceDelay: 200, shortcuts: [] }},
    'profile_3': { name: "Bananas", settings: { ...DEFAULT_PROFILE_SETTINGS, sequenceLength: 25, shortcuts: [] }},
    'profile_4': { name: "Piano", settings: { ...DEFAULT_PROFILE_SETTINGS, currentInput: INPUTS.PIANO, shortcuts: [] }},
    'profile_5': { name: "15 Rounds", settings: { ...DEFAULT_PROFILE_SETTINGS, currentMode: MODES.UNIQUE_ROUNDS, sequenceLength: 15, shortcuts: [] }}
};
