...
class SettingsManager {
	...
	applyRowMax() {
		...
		if (rowMax === 'none') {
			...
			const cardSize = parseFloat(getComputedStyle(document.documentElement).getPropertyValue('--number-size') || '40');
			const gap = 8;
			const maxWidth = (cardSize * parseInt(rowMax)) + (gap * (parseInt(rowMax) - 1));
