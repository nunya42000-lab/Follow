...
export class SettingsManager {
    ...
    initListeners() {
        ...
        this.injectGestureInputToggle(); // ADDED THIS
        ...
        bind(this.dom.gestureInputToggle, 'isGestureInputEnabled', true); // FIXED HERE
        ...
        // --- FIXED: Use correct DOM element from cache ---
        if(this.dom.gestureInputToggle){
            ...
            this.dom.gestureInputToggle.addEventListener('change', (e) => {
                ...
                this.callbacks.onSave();
                this.callbacks.onUpdate && this.callbacks.onUpdate(); // Changed name to match callback
            });
        }
    }
