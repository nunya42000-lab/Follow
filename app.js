(function() {
    ...
    let lastShakeTime = 0; 
    let toastTimer = null; // NEW: Toast timer
    ...
    var toastNotification = null, toastMessage = null; // NEW: Toast
...
Let's start with Round 1.`;
    ...
    function initSensorListeners() {
        ...
        if ('DeviceMotionEvent' in window) {
            if (typeof DeviceMotionEvent.requestPermission === 'function') {
                // This is the iOS 13+ way. We ask for it on first (meaningful) user touch.
                // We'll ask when the "Get Started" button is clicked.
            } else {
    ...
    function requestSensorPermissions() {
        ...
        // Add DeviceOrientationEvent permission request here too
    }
